...
describe('getPayload using default keys', function () {
    it('should return correct string', function () {
        ...
        LORA.getPayload(data,'2B7E151628AED2A6ABF7158809CF4F3C').ascii.should.equal('AABBCCDDEEFFGGHHIIJJKKLLMMNN');
        LORA.getPayload(data,'2B7E151628AED2A6ABF7158809CF4F3C','2B7E151628AED2A6ABF7158809CF4F3C').ascii.should.equal('AABBCCDDEEFFGGHHIIJJKKLLMMNN');
    });
});